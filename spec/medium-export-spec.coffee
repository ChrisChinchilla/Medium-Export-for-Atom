MediumExport = require '../lib/medium-export'
  ...
  describe "when the medium-export:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        mediumExportElement = workspaceElement.querySelector('.medium-export')
        expect(mediumExportElement).toExist()

        mediumExportPanel = atom.workspace.panelForItem(mediumExportElement)
